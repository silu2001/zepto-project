    ...
    return (
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 font-medium bg-[#4fbf8b] text-white hover:bg-[#44ae7c] transition"
                        >
                            Buy now
                        </button>
                    </div>
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <button onClick={()=>{navigate('/products');scrollTo(0,0)}} className='mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-[#4fbf8b] hover:bg-[#44ae7c]/30 transition'>See more</button>
